...
import { addGptMovieResultsFromTMDB } from '../utils/gptSlice';
...
function GPTSearchBar(props) {
    ...
    const handleGPTSearchClick = async () => {
        ...
        const gptQuery = `Act as a movie recommendation system and suggest some Tamil movies for the query ${searchText.current.value}. Only give me names of 5 movies, comma separated like the example result given ahead. Example Result: Don, Run, Mila, Pink, Ghilli.`
